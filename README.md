...
| Roteador-Pato Branco  | Fa0/0   | 200.134.**41**.*??*   | 255.255.255.*192* |      -       | 2001:DB8:CAFE:**29** *00*::*1*/64    |   FE80::1  |    -    |
| Roteador-Pato Branco  | Se0/0/0 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*00*:*1*/112 |   EUI-64   |    -    |
| Roteador-Pato Branco  | Se0/0/1 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*03*:*2*/112 |   EUI-64   |    -    |
| Roteador-Fco. Beltrão | Fa0/0   | 200.134.**41**.*??*  | 255.255.255.*224* |      -       | 2001:DB8:CAFE:**29** *00*::*1*/64    |   FE80::1  |    -    |
| Roteador-Fco. Beltrão | Se0/0/0 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*02*:*1*/112 |   EUI-64   |    -    |
| Roteador-Fco. Beltrão | Se0/0/1 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*01*:*2*/112 |   EUI-64   |    -    | 
| Roteador-Vitorino     | Se0/0/0 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*00*:*2*/112 |   EUI-64   |    -    | 
| Roteador-Vitorino     | Se0/0/1 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*01*:*1*/112 |   EUI-64   |    -    | 
| Roteador-Itapejara    | Se0/0/0 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*03*:*1*/112 |   EUI-64   |    -    | 
| Roteador-Itapejara    | Se0/0/1 | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*04*:*1*/112 |   EUI-64   |    -    | 
| Roteador-Itapejara    | Fa0/1   | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*02*:*2*/112 |   EUI-64   |    -    | 
| Roteador-Coronel      | Fa0/0   | 200.134.**41**.*??*  | 255.255.255.*224* |      -       | 2001:DB8:CAFE:**29** *02*::*1*/64    |   FE80::1  |    -    |
| Roteador-Coronel      | Fa0/1   | 200.134.**41**.*??* | 255.255.255.*252* |      -       | 2001:DB8:CAFE:**29**FF::*04*:*2*/112 |   EUI-64   |    -    | 
